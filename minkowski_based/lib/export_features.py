	...
	with torch.no_grad():
		for iteration in range(max_iter):
			...
			for sout_layer, save_pred_layer_feat_dir in zip(
				...
				np.save(os.path.join(save_pred_layer_feat_dir, "weighted_sum", filename), per_point_feat_layer)
				...
				np.save(os.path.join(save_pred_layer_feat_dir, "max", filename), per_point_feat_layer)
