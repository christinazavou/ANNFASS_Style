import lib.datasets.buildnet as buildnet
import lib.datasets.stylenet as stylenet
import lib.datasets.stylenet_component as stylenet_component
import lib.datasets.stylenet_rnv as stylenet_rnv
...
add_datasets(buildnet)
add_datasets(stylenet)
add_datasets(stylenet_component)
add_datasets(stylenet_rnv)
