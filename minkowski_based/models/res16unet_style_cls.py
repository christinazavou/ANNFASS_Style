...
class StyleRes16UNetBase(ResNetBase):
  BLOCK = None
  ...
  def __init__(self, in_channels, out_channels, config, D=3, **kwargs):
    super(StyleRes16UNetBase, self).__init__(in_channels, out_channels, config, D)
  ...
  def forward(self, x):
    ...
    if self.export_feat:
      return self.final(out), out, out_n_2, out_n_3

    return self.final(out)


class StyleRes16UNet14(StyleRes16UNetBase):
  BLOCK = BasicBlock
  LAYERS = (1, 1, 1, 1, 1, 1, 1, 1)



class StyleRes16UNet34(StyleRes16UNetBase):
  BLOCK = BasicBlock
  LAYERS = (2, 3, 4, 6, 2, 2, 2, 2)


class StyleRes16UNet34A(StyleRes16UNet34):
