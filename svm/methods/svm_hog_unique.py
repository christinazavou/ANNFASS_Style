...
from svm.utils.datasets import StylisticImagesEncodingsDataLoader, StylisticImagesHogDataLoader
...
class SVM:
    ...
    def __init__(self, train_csv, test_csv, classes, pkl_filename, ignore_classes=None, unique_dirs=None):
        self.train_loader = iter(StylisticImagesHogDataLoader(train_csv, batch_size=5000, num_workers=0))
        self.test_loader = iter(StylisticImagesHogDataLoader(test_csv, batch_size=5000, num_workers=0))
