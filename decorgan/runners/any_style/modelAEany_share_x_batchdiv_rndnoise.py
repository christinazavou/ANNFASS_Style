...
from runners.common_dp2 import IM_AE_ANY_SHARE_COMMON, IM_AE_TWO_DATASETS_RNDNOISE
...
class IM_AE(IM_AE_ANY_SHARE_COMMON, IM_AE_TWO_DATASETS_RNDNOISE):
    ...
    def train(self, config):
        ...
        while epoch < training_epoch:
            ...
            for idx in range(0, epoch_size-config.batch_size, config.batch_size):
                ...
                for dstep in range(config.d_steps):
