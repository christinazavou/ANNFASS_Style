...
from dataset_rot import RotRndNoiseFilesDataset
from runners.common import IM_AE_STATIC
from runners.common_dp2 import IM_AE_TWO_DATASETS_ROT, IM_AE_ANY_SHARE_COMMON, IM_AE_TWO_DATASETS_ROT_RNDNOISE
...
class IM_AE(IM_AE_ANY_SHARE_COMMON, IM_AE_TWO_DATASETS_ROT_RNDNOISE):
